...
export const caseStudies: CaseStudy[] = [
  {
    ...
    subtitle: "10,000+ field consultants were losing time to tools that fought their workflows. I found the disconnect, shifted the company's design strategy, and led the fix across 4 product squads.",
  ...
  },
  {
    ...
    title: "Building Trust Into Agricultural Payments",
    subtitle: "Redesigning a $500M+ payment flow by showing customers the math, not hiding it.",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "2x online payments within one year",
...

  {
    ...
    subtitle: "Turning a deprioritized pain point into the organization's adopted onboarding standard.",
