...
const PROJECTS: Project[] = [
  {
    ...
    solution:
      "I designed this site to feel like the brand behind it. Confident, direct, and focused on the work. The side and top navigation let readers jump to what they care about instead of scrolling through each page and case study. Animations and interactions were added with intent, not as decoration, and the overall pace favors scannability over spectacle. Fit Check is the site's one AI feature for visitors. Paste a role and it gives an honest read on how my experience maps to it, grounded in my real case studies and built on the Anthropic API. One feature doing one useful thing, not a chatbot bolted on for show. Designed by me, a human, with some suggestions from Claude Design and the Impeccable skill in Claude Code. Built with Claude Code using Next.js and Tailwind.",
    reflection:
